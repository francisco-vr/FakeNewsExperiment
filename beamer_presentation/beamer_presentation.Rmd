...
Growing evidence suggests the existence of fake news is problematic (Sunstein, 2009; Lazer et.al, 2018), polarizing (Osmundsen et. al., 2021) and erodes democracy (Lance & Livingston, 2018. Partisanship increase from this years and Eco chambers participans and digital activist promotes this.
</div>
...
### Another theories about homophily and political attitudes
...
####Using the methodologies to the first group we try to test the second group hypothesis
...
Following the political homophilly effects:
...
According to the literature on the effects of echo chambers
...
>We will show you below 7 different headlines that are circulating in Social Media, some of which are true and others false. You will have to indicate if they are true or false.

>(At the end of this survey you will be shown your results).
...
![](beamer_presentation_files/Plot1General.png)
